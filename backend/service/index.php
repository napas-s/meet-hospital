                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <?php
                                    ...
                                    $query_services = "SELECT * FROM services ORDER BY ser_id ASC;" or die("Error:" . mysqli_error($con));
                                    $result_services = mysqli_query($con, $query_services);
                                    $i = 1;
                                ?>
                                <tbody>
                                    <!-- loop ข้อมูลที่ query ได้ จาก services -->
                                    <?PHP  while($row = mysqli_fetch_array($result_services)) {  ?>
                                    <tr>
                                        <td class="text-center"><?PHP echo str_pad($row['ser_id'], 4, '0', STR_PAD_LEFT); ?></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="form.php?id=<?PHP echo $row['ser_id']; ?>"><button type="button" rel="tooltip" class="btn btn-success btn-icon btn-sm"><i class="fa fa-edit"></i></button></a>
                                            <a href="#"  onclick="deleteModel(this)" data-toggle="modal" data-target="#deleteModel" data-id="<?PHP echo $row['ser_id']; ?>" data-message="คุณต้องการลบข้อมูลรายการนี้หรือไม่ ?" type="button" rel="tooltip">
