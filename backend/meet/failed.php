                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            ?>
                            <h4 class="card-title"><i class="nc-icon nc-single-copy-04"></i> ประวัติการนัดหมายที่เลยกำหนด (<?PHP echo $numMeet1;?>)</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <?php
                                        ...
                                        $query_meet = "SELECT * FROM meet_service 
                                                    ...
                                                    WHERE meet_service.mt_serdateId < '$dateToday'
                                                    AND meet_service.mt_status = 1 
                                                    AND meet_service.mt_serpoint_id LIKE '%$point%' 
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="failedform.php?id=<?PHP echo $row['mt_id']; ?>"><button type="button" rel="tooltip" class="btn btn-info btn-icon btn-sm"><i class="fa fa-eye"></i></button></a>
                                            </td>
                                        </tr>
                                        <?PHP } ?>
                                    </tbody>
