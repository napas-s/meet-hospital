    ...
    <div class="main-panel">
        ...
        ?>
            ...
            <?PHP if(isset($_SESSION["Id"])){ ?>
              ...
              <input type="hidden" name="member_id" id="member_id" value="<?PHP if(isset($_SESSION["Id"])){ echo $_SESSION["Id"];}?>" /> <!-- ตัวแปร icon แจ้งเตือน -->
            ...
            <?PHP } ?>
              <div class="card ">
                <div class="card-header ">
                    <h4 class="card-title"><i class="nc-icon nc-chart-bar-32"></i> บัญชีผู้ใช้ของฉัน</h4>
                </div>
                <div class="card-body ">
                  <div class="row">
                    <div class="col-md-4">
