<?PHP
    //query count news
    $sql = "SELECT COUNT(album_id) FROM album WHERE album_status = 1;" or die("Error:" . mysqli_error($con));
    ...
    //$nquery นำไปใช้วนลูป
    $sql_nquery = "SELECT * FROM album WHERE album.album_status = 1  $limit;" or die("Error:" . mysqli_error($con));
