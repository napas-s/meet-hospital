                                    ...
                                    <div class="tab-pane" role="tabpanel" id="step2">
                                        <div class="tap-box">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <button id="meetTab" class="btn btn-block button button-border button-rounded button-fill button-green2 nextBtn" type="button" onclick="meetPresent()">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="alert alert-info">
						    สำหรับท่านที่ต้องการตรวจสอบนัดหมาย <a href="checkmeet.php"><i class="icon-hand-up"></i>สามารถตรวจสอบได้ที่นี่</a>
						</div>
