                        ...
                        <?PHP  while($album = mysqli_fetch_array($nquery)) {  ?>
                            <div class="entry-news clearfix">
                                <div class="entry-image-news">
                                    ...
                                    ?>
                                    <?PHP if(count($des) != 0){ ?>
                                        <a href="albumcontent.php?p=<?PHP echo $album['album_id']; ?>"><img  class="image_fade lazyload" loading="lazy" data-src="<?PHP base_url() ?>uploads/album/<?PHP echo $des['des_img']; ?>" alt="<?PHP echo $album['album_title']; ?>"></a>
                                    <?PHP }else{ ?>
                                        <a href="albumcontent.php?p=<?PHP echo $album['album_id']; ?>"><img  class="image_fade lazyload" loading="lazy" data-src="<?PHP base_url() ?>assets/images/no-image.jpeg" alt="<?PHP echo $album['album_title']; ?>"></a>
                                    <?PHP } ?>
                                </div>
